...
const HtmlIcon = ({ width = 30, height = 30, className, ...props }: IconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 256 361" className={`${className || ''}`} {...props}>
